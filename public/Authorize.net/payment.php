...
if (!empty($paymentID)) {
    echo "<script>alert('Your Payment has been Successful!'); location.href = 'http://livei.com';</script>";
}
else {
    echo "<script>alert('Your Payment has Failed'); location.href = 'http://livei.com';</script>";
}
?>?