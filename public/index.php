...
//hello
	...
	session_start();
	$GLOBALS["cookieuser"] = "user";

	function checkCookie() {
		$cookieuser = $GLOBALS["cookieuser"];
		if(!isset($_COOKIE[$cookieuser])) {
			$GLOBALS["cookielogin"] = true;
			//echo "<script>alert('Hello Friend! Welcome To Livei.com. Please Register and Login.')</script>";
		} else {
			$GLOBALS["cookielogin"] = true;
			//echo "<script>alert('Welcome back ".$_COOKIE[$cookieuser].", Please Login!')</script>";
		}
	}
	...
	if($_SESSION["loginStatus"]==NULL){
		...
		$cookieuser = $GLOBALS["cookieuser"];
		$cookievalue = $_SESSION['firstname'];
		setcookie($cookieuser, $cookievalue, time() + (86400)*30, "livei.com");
		//echo "<script>alert('Thank you for Login Livei.com We're Happy to Serve you 24/7!')</script>";
	}
?>
<!DOCTYPE html>
<html>
...
<style type="text/css">
    ...
    /* Show the dropdown menu on click */
        ...
        .highlight {background-color: rgba(0, 0, 0, 0.3);}
...
<body onload="playVideo('stream01')">
                ...
                <img id="dropdown" class="dropdown" src="burger.png" onclick="showContent(this.id)">

                <div class="breadcrumbs">
                	<?php
                		if ($loginStatus) {
                			echo "
            			<a onclick='clickBreadcrumbs(this.id)' id='account'><img src='".$_SESSION["profilepicture"]."' id='userLogo'><span class='dot'></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Hi! ".$firstname."</a>
			...
			<?php 
                        	if ($loginStatus) {
                        		echo "<a id='accounts' class='accounts' onclick='displayAccount()'>My Account</a>";
                        	}
                        	else {
    ...
    <div class="crawler">
                <marquee id="text" scrollamount="4" behavior="scroll" direction="left" onmouseover="this.stop()" onmouseout="this.start()">
                   	<?php
                        ...
                        if ($loginStatus) {
				     for ($i=0; $i < 50; $i++) {
					echo "<img id='logo' src='liveiLogo.png'>&nbsp;&nbsp;&nbsp;&nbsp;Welcome ".$firstname."! Thank you, for being a part of Livei.com community since ".$date."&nbsp;&nbsp;&nbsp;&nbsp;";
				     }
                                }
            ...
            <script>
                function displayAccount() {
                        ...
                        document.getElementById("location1").innerHTML = "My Account";
            ...
            <div id="paywallContainer" class="paywallContainer">   
                <?php include 'Authorize.net/index.php';?>
            </div>
...
po.src = '//www.livei.com/lhc_web/index.php/chat/getstatus/(click)/internal/(position)/bottom_left/(ma)/br/(top)/350/(units)/pixels/(leaveamessage)/true/(theme)/1?r='+referrer+'&l='+location;
